...
const Week = ({ items, aqua, updateTotal }) => {
    ...
    const days = ["1", "2", "3", "4", "5", "6", "7"]; // Standard 7 day week
                ...
                {names.map((name) => (
                    ...
                    >
                        <div className="flex items-center justify-between mb-4 border-b border-base-content/5 pb-2">
                            ...
                            <div className="w-8 h-8 rounded-lg bg-base-300/50 flex items-center justify-center text-[10px] font-bold opacity-40">7D</div>
                        </div>
